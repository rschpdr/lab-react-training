...
class Dice extends React.Component{
  ...
  roolDice =() => {
    ...
    setTimeout(() => {
      this.setState({ randomNumber: Math.floor(Math.random() *5)+ 1});
    },1000);
  }
  render() {
    return <img src={this.state.diceImgs[this.state.randomNumber]} alt="Image of a Dice" onClick={this.roolDice}/>
  }  
};
